            ...
            if (req.body.delete == 'delete context') {
                ...
                dbneo.cypherQuery(idQuery, function(err, uid) {
                    ...
                    delete_query[0] =
                        ...
                        context_id +
                        "') YIELD relationship AS rel WITH DISTINCT rel DELETE rel;"

                    delete_query[1] =
                        "CALL db.index.fulltext.queryRelationships('of_context_fulltext','context:" +
                        context_id +
                        "') YIELD relationship AS rel WITH DISTINCT rel DELETE rel;"

                    delete_query[2] =
                        "CALL db.index.fulltext.queryRelationships('by_context_fulltext','context:" +
                        context_id +
                        "') YIELD relationship AS rel WITH DISTINCT rel DELETE rel;"
                ...
                delete_query[0] =
                    "CALL db.index.fulltext.queryRelationships('to_statement_fulltext','statement:" +
                    req.body.statementid +
                    "') YIELD relationship AS rel WITH DISTINCT rel DELETE rel;"

                delete_query[1] =
                    "CALL db.index.fulltext.queryRelationships('at_statement_fulltext','statement:" +
                    req.body.statementid +
                    "') YIELD relationship AS rel WITH DISTINCT rel DELETE rel;"

                delete_query[2] =
                    "CALL db.index.fulltext.queryRelationships('by_statement_fulltext','statement:" +
                    req.body.statementid +
                    "') YIELD relationship AS rel WITH DISTINCT rel DELETE rel;"
